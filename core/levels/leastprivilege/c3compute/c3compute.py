...
def create():
    ...
    # Insert deployment
    config_template_args = {'nonce': nonce,'func_upload_url1':func_upload_url1,'func_upload_url2':func_upload_url2, 'secret': secret, 'prefix':RESOURCE_PREFIX,'fvar1': fvar1.decode("utf-8"),'fvar2': fvar2.decode("utf-8") }
